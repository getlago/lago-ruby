...
```shell
gem install ./lago_ruby-v0.52.0-beta.gem
```

(for development, run `gem install --dev ./lago_ruby-v0.52.0-beta.gem` to install the development dependencies)

or publish the gem to a gem hosting service, e.g. [RubyGems](https://rubygems.org/).

Finally add this to the Gemfile:

    gem 'lago_ruby', '~> v0.52.0-beta'
