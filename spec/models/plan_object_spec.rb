...
# Unit tests for OpenapiClient::PlanObject
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::PlanObject do
  let(:instance) { OpenapiClient::PlanObject.new }

  describe 'test an instance of PlanObject' do
    it 'should create an instance of PlanObject' do
      expect(instance).to be_instance_of(OpenapiClient::PlanObject)
    end
  end
