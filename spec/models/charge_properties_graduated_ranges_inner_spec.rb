...
# Unit tests for OpenapiClient::ChargePropertiesGraduatedRangesInner
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::ChargePropertiesGraduatedRangesInner do
  let(:instance) { OpenapiClient::ChargePropertiesGraduatedRangesInner.new }
  ...
  describe 'test an instance of ChargePropertiesGraduatedRangesInner' do
    it 'should create an instance of ChargePropertiesGraduatedRangesInner' do
      expect(instance).to be_instance_of(OpenapiClient::ChargePropertiesGraduatedRangesInner)
    end
  end
