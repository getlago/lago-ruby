...
# Unit tests for OpenapiClient::CreditObjectItem
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::CreditObjectItem do
  let(:instance) { OpenapiClient::CreditObjectItem.new }

  describe 'test an instance of CreditObjectItem' do
    it 'should create an instance of CreditObjectItem' do
      expect(instance).to be_instance_of(OpenapiClient::CreditObjectItem)
    end
  end
