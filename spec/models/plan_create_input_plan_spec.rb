...
# Unit tests for OpenapiClient::PlanCreateInputPlan
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::PlanCreateInputPlan do
  let(:instance) { OpenapiClient::PlanCreateInputPlan.new }

  describe 'test an instance of PlanCreateInputPlan' do
    it 'should create an instance of PlanCreateInputPlan' do
      expect(instance).to be_instance_of(OpenapiClient::PlanCreateInputPlan)
    end
  end
