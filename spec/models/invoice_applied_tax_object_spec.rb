...
# Unit tests for OpenapiClient::InvoiceAppliedTaxObject
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::InvoiceAppliedTaxObject do
  let(:instance) { OpenapiClient::InvoiceAppliedTaxObject.new }

  describe 'test an instance of InvoiceAppliedTaxObject' do
    it 'should create an instance of InvoiceAppliedTaxObject' do
      expect(instance).to be_instance_of(OpenapiClient::InvoiceAppliedTaxObject)
    end
  end
