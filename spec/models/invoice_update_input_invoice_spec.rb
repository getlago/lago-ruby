...
# Unit tests for OpenapiClient::InvoiceUpdateInputInvoice
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::InvoiceUpdateInputInvoice do
  let(:instance) { OpenapiClient::InvoiceUpdateInputInvoice.new }

  describe 'test an instance of InvoiceUpdateInputInvoice' do
    it 'should create an instance of InvoiceUpdateInputInvoice' do
      expect(instance).to be_instance_of(OpenapiClient::InvoiceUpdateInputInvoice)
    end
  end
