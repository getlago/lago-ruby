...
# Unit tests for OpenapiClient::FeeAppliedTaxObject
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::FeeAppliedTaxObject do
  let(:instance) { OpenapiClient::FeeAppliedTaxObject.new }

  describe 'test an instance of FeeAppliedTaxObject' do
    it 'should create an instance of FeeAppliedTaxObject' do
      expect(instance).to be_instance_of(OpenapiClient::FeeAppliedTaxObject)
    end
  end
