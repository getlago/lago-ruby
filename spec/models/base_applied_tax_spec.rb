...
# Unit tests for OpenapiClient::BaseAppliedTax
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::BaseAppliedTax do
  let(:instance) { OpenapiClient::BaseAppliedTax.new }

  describe 'test an instance of BaseAppliedTax' do
    it 'should create an instance of BaseAppliedTax' do
      expect(instance).to be_instance_of(OpenapiClient::BaseAppliedTax)
    end
  end
