...
# Unit tests for OpenapiClient::PlanUpdateInputPlan
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::PlanUpdateInputPlan do
  let(:instance) { OpenapiClient::PlanUpdateInputPlan.new }

  describe 'test an instance of PlanUpdateInputPlan' do
    it 'should create an instance of PlanUpdateInputPlan' do
      expect(instance).to be_instance_of(OpenapiClient::PlanUpdateInputPlan)
    end
  end
