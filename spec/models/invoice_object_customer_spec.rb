...
# Unit tests for OpenapiClient::InvoiceObjectCustomer
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::InvoiceObjectCustomer do
  let(:instance) { OpenapiClient::InvoiceObjectCustomer.new }

  describe 'test an instance of InvoiceObjectCustomer' do
    it 'should create an instance of InvoiceObjectCustomer' do
      expect(instance).to be_instance_of(OpenapiClient::InvoiceObjectCustomer)
    end
  end
