...
# Unit tests for OpenapiClient::PlanUpdateInputPlanChargesInner
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::PlanUpdateInputPlanChargesInner do
  let(:instance) { OpenapiClient::PlanUpdateInputPlanChargesInner.new }
  ...
  describe 'test an instance of PlanUpdateInputPlanChargesInner' do
    it 'should create an instance of PlanUpdateInputPlanChargesInner' do
      expect(instance).to be_instance_of(OpenapiClient::PlanUpdateInputPlanChargesInner)
    end
  end
