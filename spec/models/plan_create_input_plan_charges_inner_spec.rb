...
# Unit tests for OpenapiClient::PlanCreateInputPlanChargesInner
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::PlanCreateInputPlanChargesInner do
  let(:instance) { OpenapiClient::PlanCreateInputPlanChargesInner.new }
  ...
  describe 'test an instance of PlanCreateInputPlanChargesInner' do
    it 'should create an instance of PlanCreateInputPlanChargesInner' do
      expect(instance).to be_instance_of(OpenapiClient::PlanCreateInputPlanChargesInner)
    end
  end
