...
# Unit tests for OpenapiClient::OrganizationUpdateInputOrganization
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::OrganizationUpdateInputOrganization do
  let(:instance) { OpenapiClient::OrganizationUpdateInputOrganization.new }
  ...
  describe 'test an instance of OrganizationUpdateInputOrganization' do
    it 'should create an instance of OrganizationUpdateInputOrganization' do
      expect(instance).to be_instance_of(OpenapiClient::OrganizationUpdateInputOrganization)
    end
  end
