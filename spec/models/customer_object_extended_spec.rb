...
# Unit tests for OpenapiClient::CustomerObjectExtended
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::CustomerObjectExtended do
  let(:instance) { OpenapiClient::CustomerObjectExtended.new }

  describe 'test an instance of CustomerObjectExtended' do
    it 'should create an instance of CustomerObjectExtended' do
      expect(instance).to be_instance_of(OpenapiClient::CustomerObjectExtended)
    end
  end
