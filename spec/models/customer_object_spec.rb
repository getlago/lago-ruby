...
# Unit tests for OpenapiClient::CustomerObject
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::CustomerObject do
  let(:instance) { OpenapiClient::CustomerObject.new }

  describe 'test an instance of CustomerObject' do
    it 'should create an instance of CustomerObject' do
      expect(instance).to be_instance_of(OpenapiClient::CustomerObject)
    end
  end
