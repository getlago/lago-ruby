...
# Unit tests for LagoAPI::CreateWebhookEndpointRequestWebhookEndpoint
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe LagoAPI::CreateWebhookEndpointRequestWebhookEndpoint do
  let(:instance) { LagoAPI::CreateWebhookEndpointRequestWebhookEndpoint.new }
  ...
  describe 'test an instance of CreateWebhookEndpointRequestWebhookEndpoint' do
    it 'should create an instance of CreateWebhookEndpointRequestWebhookEndpoint' do
      expect(instance).to be_instance_of(LagoAPI::CreateWebhookEndpointRequestWebhookEndpoint)
    end
  end
