...
# Unit tests for OpenapiClient::CreateWebhookEndpointRequestWebhookEndpoint
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::CreateWebhookEndpointRequestWebhookEndpoint do
  let(:instance) { OpenapiClient::CreateWebhookEndpointRequestWebhookEndpoint.new }
  ...
  describe 'test an instance of CreateWebhookEndpointRequestWebhookEndpoint' do
    it 'should create an instance of CreateWebhookEndpointRequestWebhookEndpoint' do
      expect(instance).to be_instance_of(OpenapiClient::CreateWebhookEndpointRequestWebhookEndpoint)
    end
  end
