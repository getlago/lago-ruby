...
# Unit tests for OpenapiClient::BillableMetricBaseInput
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::BillableMetricBaseInput do
  let(:instance) { OpenapiClient::BillableMetricBaseInput.new }

  describe 'test an instance of BillableMetricBaseInput' do
    it 'should create an instance of BillableMetricBaseInput' do
      expect(instance).to be_instance_of(OpenapiClient::BillableMetricBaseInput)
    end
  end
