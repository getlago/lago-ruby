...
# Unit tests for OpenapiClient::ChargeObject
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::ChargeObject do
  let(:instance) { OpenapiClient::ChargeObject.new }

  describe 'test an instance of ChargeObject' do
    it 'should create an instance of ChargeObject' do
      expect(instance).to be_instance_of(OpenapiClient::ChargeObject)
    end
  end
