...
# Unit tests for LagoAPI::CreateWebhookEndpoint200ResponseWebhookEndpoint
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe LagoAPI::CreateWebhookEndpoint200ResponseWebhookEndpoint do
  let(:instance) { LagoAPI::CreateWebhookEndpoint200ResponseWebhookEndpoint.new }
  ...
  describe 'test an instance of CreateWebhookEndpoint200ResponseWebhookEndpoint' do
    it 'should create an instance of CreateWebhookEndpoint200ResponseWebhookEndpoint' do
      expect(instance).to be_instance_of(LagoAPI::CreateWebhookEndpoint200ResponseWebhookEndpoint)
    end
  end
